...
exp_data <- read.csv("format_B12_exp.csv", sep = ";")
exp_clump <- read.csv("B12_clump.csv", sep = ";")
...
#None of the 8 SNPs from the B12 GWAS are present in the outcome dataset
...
write.csv(harm,"../../4.Harmonize/B12_Nalls_harm.csv", row.names = FALSE)


#Analysis
harm <- read.csv("../../4.Harmonize/B12_Nalls_harm.csv") #Run this if object not already created
...
write.csv2(mr_results, "../../../results/MR/mediation_B12_PD_Nalls.csv", row.names = FALSE)
